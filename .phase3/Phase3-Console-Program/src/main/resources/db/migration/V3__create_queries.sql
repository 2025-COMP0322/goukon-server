...
CREATE OR REPLACE VIEW V_TYPE1_QUERY1 AS
...
CREATE OR REPLACE VIEW V_TYPE1_QUERY2 AS
...
CREATE OR REPLACE VIEW V_TYPE2_QUERY1 AS
...
CREATE OR REPLACE VIEW V_TYPE2_QUERY2 AS
...
CREATE OR REPLACE VIEW V_TYPE3_QUERY1 AS
...
CREATE OR REPLACE VIEW V_TYPE3_QUERY2 AS
...
CREATE OR REPLACE VIEW V_TYPE4_QUERY1 AS
SELECT student_id, name, age, department
FROM STUDENT
WHERE age < (SELECT AVG(age) FROM STUDENT);

-- Query 4-2: 가장 많은 그룹이 속한 학과의 학생들 조회
CREATE OR REPLACE VIEW V_TYPE4_QUERY2 AS
...
CREATE OR REPLACE VIEW V_TYPE5_QUERY1 AS
SELECT s.student_id, s.name, s.department, s.age
FROM STUDENT s
WHERE EXISTS (
...
CREATE OR REPLACE VIEW V_TYPE5_QUERY2 AS
SELECT s.student_id, s.name, s.department, s.age
FROM STUDENT s
WHERE EXISTS (
...
CREATE OR REPLACE VIEW V_TYPE6_QUERY1 AS
...
CREATE OR REPLACE VIEW V_TYPE6_QUERY2 AS
...
CREATE OR REPLACE VIEW V_TYPE7_QUERY1 AS
...
CREATE OR REPLACE VIEW V_TYPE7_QUERY2 AS
...
CREATE OR REPLACE VIEW V_TYPE8_QUERY1 AS
...
CREATE OR REPLACE VIEW V_TYPE8_QUERY2 AS
...
CREATE OR REPLACE VIEW V_TYPE9_QUERY1 AS
...
CREATE OR REPLACE VIEW V_TYPE9_QUERY2 AS
SELECT s.department,
...
CREATE OR REPLACE VIEW V_TYPE10_QUERY1 AS
...
CREATE OR REPLACE VIEW V_TYPE10_QUERY2 AS
